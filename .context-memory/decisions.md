...
- 2026-05-11: Docs `$run` : supprimer les docs `safety-fallbacks*` redondantes; garder le filet opérationnel dans `tasks/runs/README.md` + le détail exécutable dans `.agents/skills/run/SKILL.md`.
