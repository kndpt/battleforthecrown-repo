...
description: Deep code quality audit + structural refactor of packages/shared. Two phases: annotated findings report, then one scoped PR ready for review. Runs weekly Saturday night via Routine.
---
