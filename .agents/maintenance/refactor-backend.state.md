...
last: 2026-06-13 | theme D5 garrison-merge | PR maint/refactor-backend/garrison-merge
full: `archive/refactor-backend/2026-06-13-full.md`
...
B3 → PR #91 ouverte | G1 intentionnel (tx safety) | D4 no factory value
