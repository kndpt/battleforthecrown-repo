...
last: 2026-06-17 | theme OB1/OB2 notification planner | PR maint(refactor-backend): notification planner for outbox dispatcher
full: `archive/refactor-backend/2026-06-17-full.md`
...
| W1 | Med | combat/combat.worker.ts | 1772 L, 4 kinds cohabitent — split par kind L effort |
...
| D4 | Low | resources.service.ts + strategy + gameplay (multi-files) | buildings.find by type répété 8+ sites — helper |
...
OB1/OB2 ce run | B3/E1/U2/D4(F1) déjà traités runs précédents | G1 intentionnel (tx safety)
