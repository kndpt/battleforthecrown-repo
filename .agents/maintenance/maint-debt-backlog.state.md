...
| shared/logic/training-time.ts | open PRs #99–#110 — calculateTrainingTime spec |
| shared/logic/production.ts | open PR #102 — calculateProductionRate spec |
| shared/world/entities.ts normalizeTier | open PR #108 — unit spec |
| pixi world-types isFoggedEntity dup | open PR #105 — import from shared |
| shared/resources/affordability.ts | open PR #93 — unused module removal |
| ReportDetailModal console.error stubs | catch-only logging — needs error UX decision |
