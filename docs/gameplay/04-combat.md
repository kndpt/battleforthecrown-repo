...
- **Raid victorieux** : pertes selon le ratio puissance attaque vs défense, butin proportionnel à la capacité de transport restante. Au-delà d'un rayon, la capacité de pillage subit une **friction logistique par distance** (raid seul, jamais la conquête) : [`29-distance-loot-friction.md`](./29-distance-loot-friction.md).
