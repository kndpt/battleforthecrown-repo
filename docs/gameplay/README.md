...
26. [`26-private-map-markers.md`](./26-private-map-markers.md) — **Marqueurs de carte privés** (MVP léger) : mémoire stratégique posée sur une tile libre `(worldId, x, y)`, 6 kinds + note ≤80, cap 50 par monde, privé par compte (off-fog), purgé à l'archive. Zéro effet gameplay.
