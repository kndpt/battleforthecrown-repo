...
| Phase 8 — Consolidation doc | ✅ Done (2026-05-05) — backend AGENTS.md split + docs/architecture/ + docs/gameplay/ consolidés | [CHANGELOG](./CHANGELOG.md#patch--consolidation-doc-backend--gameplay-2026-05-05) |
