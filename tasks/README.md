...
- [077 — Cleanup village narrative post-victoire](./077-cleanup-narrative-village-post-victory.md) — 🟠 Moyen. Village `ONBOARDING_NARRATIVE` persiste après victoire ; supprimer dans `reconcileStateFromFacts` après complétion.
