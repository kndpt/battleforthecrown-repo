...
- [41 — Période de capture : `PendingConquest` + worker](./41-capture-window-data-model.md) 🔴 Bloquant conquête — issue du run 006. Data model Prisma + `conquest-finalize.worker` + 3 events Outbox.
