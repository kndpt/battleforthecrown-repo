...
- [042 — Détail d'un royaume](./runs/archive/042-feature-world-detail-page.md) — ✅ `DONE` (2026-05-31). Bouton `Détails`, route `/worlds/:worldId`, contrat public `PublicWorld.map`, composant détail props-first et tests/smoke/static-check.
