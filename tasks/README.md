...
- [59 — Smokes backend : flakies par ordering Jest](./59-smokes-jest-ordering-flakies.md) — 🟠 Moyen. Les smokes ne sont pas déterministes ; corriger l'isolation ou forcer un sequencer stable pour pouvoir s'y fier.
