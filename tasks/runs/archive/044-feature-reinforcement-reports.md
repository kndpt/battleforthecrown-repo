...
- Run [`010 — Implémentation frontend renforts`](./010-implementation-frontend-reinforcements.md) ✅ DONE : actions `Renforcer`, `Rappeler`, `Renvoyer`, endpoint garnison et events WS.
...
- Run [`012 — Inbox combat reports`](./012-feature-inbox-combat-reports.md) ✅ DONE : inbox combat persistante avec read/delete par participant.
...
- [`tasks/runs/archive/010-implementation-frontend-reinforcements.md`](./010-implementation-frontend-reinforcements.md) — UI garnison et events WS.
...
- [`tasks/runs/archive/012-feature-inbox-combat-reports.md`](./012-feature-inbox-combat-reports.md) — inbox combat persistante.
