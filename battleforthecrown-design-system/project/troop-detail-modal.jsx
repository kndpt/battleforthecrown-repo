      ...
      >
        <span
          style={{
            ...
            borderRadius: 6,
            background:
              "linear-gradient(to bottom, rgba(60,38,25,.15), rgba(60,38,25,.04))",
  ...
  const rows = [
    {
      icon: "🛡",
      label: "vs Infanterie",
      v: stats.defenseInfantry,
      m: max.defenseInfantry,
      d: delayBase,
    },
    {
      icon: "🐎",
      label: "vs Cavalerie",
      v: stats.defenseCavalry,
      m: max.defenseCavalry,
      d: delayBase + 70,
    },
    {
      icon: "🏹",
      label: "vs Archers",
      v: stats.defenseArcher,
      m: max.defenseArcher,
      d: delayBase + 140,
    },
  ];
      ...
      >
        <span
          style={{
            ...
            borderRadius: 6,
            background:
              "linear-gradient(to bottom, rgba(60,38,25,.18), rgba(60,38,25,.05))",
    ...
    >
      ...
      <div
        style={{
          ...
          flexShrink: 0,
          boxShadow:
            "inset 0 1px 0 rgba(255,255,255,.18), 0 4px 0 rgba(0,0,0,.18)",
        }}
      >
        {/* faint amber halo */}
        <span
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 50% 40%, rgba(241,196,15,.45) 0%, rgba(241,196,15,0) 70%)",
          }}
        />
        <img
          src={troop.portrait}
      ...
      >
        ...
        <div
          style={{
            ...
            color: BFTC_T.inkSoft,
            paddingLeft: 8,
            borderLeft: "2px solid rgba(60,38,25,.25)",
            marginTop: 2,
          }}
        >
          {troop.tagline}
  ...
  return (
    <div
      style={{
        ...
        boxShadow:
          "inset 0 1px 0 rgba(255,255,255,.6), 0 2px 0 rgba(0,0,0,.12)",
        padding: "8px 10px",
        display: "flex",
        alignItems: "center",
        gap: 9,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            style={{ flex: 1, height: 1, background: "rgba(60,38,25,.22)" }}
          />
          <span
            style={{
              fontFamily: BFTC_T.font,
        ...
        <div
          style={{
            ...
            borderRadius: 14,
            background:
              "linear-gradient(to bottom, rgba(255,255,255,.55) 0%, rgba(244,228,193,.5) 100%)",
            border: "1.5px solid rgba(60,38,25,.22)",
            boxShadow:
              "inset 0 1px 0 rgba(255,255,255,.55), inset 0 -10px 18px rgba(0,0,0,.05)",
            display: "flex",
            flexDirection: "column",
            gap: 11,
          }}
        >
          ...
          <StatBar
            icon="📦"
            label="Capacité de pillage"
            value={s.carryCapacity}
            max={FIELD_MAX.carryCapacity}
            delay={490}
          />
        </div>
        ...
        >
          ...
          <SubStat
            icon="👤"
            label="Population"
            value={`${troop.populationCost} place`}
          />
        </div>
      ...
      <div
        style={{
          ...
          background:
            "linear-gradient(to bottom, rgba(93,74,50,.95), rgba(60,38,25,.97))",
      ...
      >
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <PixelBtn variant="neutral" size="md" full>
            Fermer
          </PixelBtn>
  ...
  return (
    <div
      style={{
        ...
        border: "1.5px solid rgba(60,38,25,.22)",
        background:
          "linear-gradient(to bottom, rgba(255,255,255,.5), rgba(244,228,193,.5))",
        padding: "6px 9px",
        display: "flex",
        alignItems: "center",
        gap: 8,
    ...
    >
      <span
        style={{
          ...
          borderRadius: 7,
          background:
            "linear-gradient(to bottom, rgba(60,38,25,.16), rgba(60,38,25,.04))",
  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        background:
          "linear-gradient(180deg,#7c9756 0%,#a8b977 28%,#cdbf8e 60%,#b89968 100%)",
      }}
    >
      <div
        style={{
          ...
          height: 62,
          background:
            "linear-gradient(to bottom, rgba(60,38,25,.94), rgba(78,56,34,.94))",
          borderBottom: "2px solid #8b7355",
        }}
      />
      <img
        src="assets/buildings/barracks.png"
        alt=""
        style={{
          position: "absolute",
          top: 200,
      ...
      />
      <img
        src="assets/buildings/castle.png"
        alt=""
        style={{
          position: "absolute",
          top: 380,
      ...
      />
      <img
        src="assets/buildings/watchtower.png"
        alt=""
        style={{
          position: "absolute",
          top: 440,
      ...
      <div
        style={{
          ...
          height: 64,
          background:
            "linear-gradient(to top, rgba(60,38,25,.95), rgba(78,56,34,.9))",
