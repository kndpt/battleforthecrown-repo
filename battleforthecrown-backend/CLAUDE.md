...
Détail dans [`.claude/rules/workers.md`](./.claude/rules/workers.md) (Outbox section).

## Règles path-scoped

- [`.claude/rules/nest-conventions.md`](./.claude/rules/nest-conventions.md) — Controllers / Services / DTOs / Guards / structure modulaire.
...
- Si une instruction du `CLAUDE.md` racine ou de `docs/` contredit le code observé, **fais confiance au code observé** et signale.
