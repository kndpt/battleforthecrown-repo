...
- [Pattern badge explicatif + modal multi-surfaces](pattern_explanatory_badge_modal.md) — badge cliquable→BaseModal réutilisé header/scout/carte ; piège anti-leak scout-only ; VillageIntelDto ≠ ScoutReport.details
