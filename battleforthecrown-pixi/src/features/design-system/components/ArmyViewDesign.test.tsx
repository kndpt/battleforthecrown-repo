...
describe('ArmyRecruitSheet queue cancellation', () => {
  it('calls the queue cancel callback with the selected training item', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Annuler la formation Milice ×18' }));
